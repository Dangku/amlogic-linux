...
static struct sec_pm_private_domain c1_pm_domains[] __initdata = {
	...
	[PDID_CX_CPU_CORE1] = POWER_DOMAIN(cpu_core1, PDID_CX_CPU_CORE1, DOMAIN_INIT_ON,
					GENPD_FLAG_ALWAYS_ON),
	[PDID_CX_DSP_A] = POWER_DOMAIN(dsp_a, PDID_CX_DSP_A, DOMAIN_INIT_OFF, 0),
	...
	[PDID_CX_AUDIO] = POWER_DOMAIN(audio, PDID_CX_AUDIO, DOMAIN_INIT_ON, 0),
	[PDID_CX_MKL_OTP] = POWER_DOMAIN(mkl_otp, PDID_CX_MKL_OTP, DOMAIN_INIT_ON,
					GENPD_FLAG_ALWAYS_ON),
	[PDID_CX_DMA] = POWER_DOMAIN(dma, PDID_CX_DMA, DOMAIN_INIT_ON, GENPD_FLAG_IRQ_SAFE),
	[PDID_CX_SDEMMC_A] = POWER_DOMAIN(sdemmc_a, PDID_CX_SDEMMC_A, DOMAIN_INIT_ON, 0),
	[PDID_CX_SRAM_A] = POWER_DOMAIN(sram_a, PDID_CX_SRAM_A, DOMAIN_INIT_ON,
					GENPD_FLAG_ALWAYS_ON),
	[PDID_CX_SRAM_B] = POWER_DOMAIN(sram_b, PDID_CX_SRAM_B, DOMAIN_INIT_OFF, 0),
	...
	[PDID_CX_SRAM_C] = POWER_DOMAIN(sram_c, PDID_CX_SRAM_C, DOMAIN_INIT_OFF, 0),
