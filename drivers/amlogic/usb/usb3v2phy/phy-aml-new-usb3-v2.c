...
static void usb3_v2_resume_xhci_port_a(void)
{
...
static void usb3_v2_force_disable_port_a(void)
{
	if (!g_phy_v2)
		return;
...
static void usb3_v2_aml_new_usb2_init(void)
{
	struct u2p_aml_regs_v2 u2p_aml_regs;
...
static int usb2_v2_get_mode(void)
{
	struct u2p_aml_regs_v2 u2p_aml_regs;
	union usb_r5_v2 r5 = {.d32 = 0};
	union u2p_r2_v2 reg2;
...
static int amlogic_new_usb3_v2_probe(struct platform_device *pdev)
{
	...
	phy->resume_xhci_p_a = usb3_v2_resume_xhci_port_a;
	phy->disable_port_a = usb3_v2_force_disable_port_a;
	phy->usb2_phy_init = usb3_v2_aml_new_usb2_init;
	phy->usb2_get_mode = usb2_v2_get_mode;
